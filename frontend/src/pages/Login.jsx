      ...
      <div className="w-full max-w-6xl overflow-hidden rounded-3xl shadow-card border border-white/50 bg-white/80 dark:bg-slate-900/75 backdrop-blur-md">
        <div className="grid md:grid-cols-2">
          <section className="p-6 sm:p-10 md:p-12 lg:p-14">
            <p className="text-sm font-semibold uppercase tracking-wider text-primary">Citizen Access</p>
            <h1 className="mt-2 text-4xl font-heading font-semibold text-slate-900 dark:text-slate-100">Welcome Back</h1>
            <p className="mt-2 text-slate-600 dark:text-slate-300">Sign in to track complaints, view updates, and stay connected with city services.</p>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs text-slate-600 dark:text-slate-300">
              <div className="rounded-lg bg-white/70 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 px-3 py-2 flex items-center gap-2">
                <MapPinned size={14} className="text-primary" /> Local issue tracking
              </div>
              <div className="rounded-lg bg-white/70 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 px-3 py-2 flex items-center gap-2">
                <BellRing size={14} className="text-primary" /> Real-time notifications
              </div>
              <div className="rounded-lg bg-white/70 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 px-3 py-2 flex items-center gap-2">
                <ShieldCheck size={14} className="text-primary" /> Secure role-based access
              </div>
            </div>
          </section>
          ...
          <aside className="hidden md:flex flex-col justify-center p-10 lg:p-14 bg-gradient-to-br from-primary via-blue-500 to-secondary text-white">
            <p className="text-sm uppercase tracking-wider text-white/80">CivicPulse Portal</p>
            <h2 className="mt-3 text-4xl font-heading font-bold leading-tight">Build A Better City, Together</h2>
            <p className="mt-5 text-white/90 leading-relaxed max-w-md">
              Report civic issues, monitor progress, and collaborate with officers and admins in one transparent platform.
            </p>

            <div className="mt-7 space-y-3 text-sm">
              <p className="rounded-xl bg-white/15 border border-white/25 px-4 py-3">24x7 complaint submission</p>
              <p className="rounded-xl bg-white/15 border border-white/25 px-4 py-3">Track every status update</p>
              <p className="rounded-xl bg-white/15 border border-white/25 px-4 py-3">Give feedback after resolution</p>
            </div>
